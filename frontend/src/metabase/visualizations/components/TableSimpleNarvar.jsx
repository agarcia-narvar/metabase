...
class TableSimple extends Component {
  ...
  onBulkClick = () => {
    console.log("Do bulk things!", {
      data: this.props.data,
      parameters: this.props.series[0].json_query.parameters,
      nativeQuery: this.props.series[0].data.native_form,
      props: this.props,
    });
  };
  ...
  setOverlayValue = (rowIndex, columnIndex, value) => {
    if (this.overlayValues[rowIndex] === undefined) {
  ...
  getOverlayValue = (rowIndex, columnIndex) => {
    if (this.overlayValues[rowIndex] === undefined) {
      return null;
    }
  ...
  getDataValue = (rowIndex, columnIndex) => {
    return this.props.data.rows[rowIndex][columnIndex];
  };
                      ...
                      return (
                        ...
                        >
                          <span
                            ...
                            onClick={
                              isClickOverride
                                ? () => this.onValueClick(rowIndex, columnIndex)
                                : isClickable
                                ? e => {
                                    onVisualizationClick({
                                      ...clicked,
                          ...
                          >
                            {this.getOverlayValue(rowIndex, columnIndex) ||
                              cellData}
                          </span>
                        </td>
                      );
