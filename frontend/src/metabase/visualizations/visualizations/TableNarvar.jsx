...
import TableSimpleNarvar from "../components/TableSimpleNarvar";
import { t } from "ttag";
...
export default class Table extends Component {
  static uiName = t`Table Narvar`;
  static identifier = "tableNarvar";
  ...
  render() {
    ...
    const TableComponent = isDashboard ? TableSimpleNarvar : TableInteractive;
